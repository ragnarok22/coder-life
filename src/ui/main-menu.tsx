...
function MenuHeader({ master }: { master: number }) {
  return (
  ...
  return (
    <div className="hero-world">
      ...
      <div className="mission-note">
        ...
        <svg className="note-scribble" viewBox="0 0 90 35" aria-hidden="true">
...
function AboutGame({ onClose }: { onClose: () => void }) {
  return (
    <Modal
    ...
    >
      ...
      <p className="modal-copy">
        Unfortunately, everyone else has other plans. Coder-Life is a tiny 3D
        comedy about the world’s most interrupted developer.
      </p>
      <div className="about-goal">
        <strong>One day. Four tasks. Too many people.</strong>
        <p>
          Get to the office, find your desk, and reach 100% work before 17:00.
          Protect your energy, manage your stress, and remember: “five minutes”
          is never five minutes.
        </p>
      </div>
      ...
      <p className="fine-print">
        A normal day lasts about 12–18 real minutes. Coding decisions, trust and
        shortcuts change each run. All gameplay and saves stay in your browser.
        Made with React, Three.js and Rapier. No external assets or services
        required.
      </p>
    </Modal>
  );
...
export function MainMenu() {
  ...
  return (
    <main className="main-menu">
      ...
      {overlay === "about" && <AboutGame onClose={() => setOverlay(null)} />}
    </main>
  );
}
